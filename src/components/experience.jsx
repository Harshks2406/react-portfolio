...
const Experience = () => {
  return (
    ...
    <motion.h1 whileInView={{opacity: 1, y: 0}} initial={{opacity: 0, y: -100}} transition={{duration: 1}} viewport={{ once: true }} className="my-20 text-center text-4xl">Experience</motion.h1>
    <div>
