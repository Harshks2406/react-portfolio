...
export const ABOUT_TEXT = `I am a dedicated software engineer with a deep interest in crafting efficient and reliable backend solutions. At Indifi Technologies, I work on integrating APIs, enhancing system performance, and collaborating with data scientists to bring machine learning models to life. I enjoy tackling complex problems and continuously strive to improve my technical skills. My work extends beyond professional projects, as I have also created innovative solutions like an AI interview platform and several web applications. I am committed to writing clean, efficient code and am always eager to learn and adapt to new technologies. I am open to opportunities where I can contribute to impactful projects and further develop my skills.`;
